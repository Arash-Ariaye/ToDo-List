...
const setStatus = (index) => {
    ...
    if(!todos[index].isCompletedDate){
        todos[index].isCompletedDate = new Date();
        todos[index].isCompletedDate = todos[index].isCompletedDate.toLocaleString();
    }else{
        todos[index].isCompletedDate = false;
    }
    localStorage.setItem(TODO_KEY, JSON.stringify(todos.reverse()));
    document.querySelector("#all-todos").innerHTML = "";
    init();
        ...
        <div class="single-todo"  style="background: ${
           ...
           <div class="user-todo">
                ...
                <div style="flex: 1">
                    ...
                    <div>
                    Set: ${dateTime.toLocaleString()} ${ todo.isCompletedDate ? "End: "+ todo.isCompletedDate  : ''}
